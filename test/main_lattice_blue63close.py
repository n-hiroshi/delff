...
def main(idx,algo):
    refdir = "./data/blue63close/"
    root = refdir + "res%03d/"%idx
    os.makedirs(root,exist_ok=True)
    name = "blue63close"

    taskids = [0,2,3,4,5,6]
    task_balance = [1,1,1,1,1,1]
    #taskids = [0]
    #task_balance = [1]
    #taskids = [0,1]
    ...
    # monomer
    in_settings_file = refdir + 'blue63close.in.settings'
    data_file = refdir + 'blue63close.data'
    monomer_gjf = refdir + 'blue63close.gjf'
    ...
    # crystal lat
    lat_gjf  = refdir + 'dummy_blue63close_crystal.gjf'
