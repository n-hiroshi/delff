...
def main(idx,algo):
    ...
    taskids = [0,1,2,3,4,5,6,7]
    task_balance = [1,[1,1],1,1,1,1,1,1]
    #taskids = [0,2,3,4,5,6,7]
    ...
    # monomer
    in_settings_file = refdir + 'hunxoe.in.settings'
    data_file = refdir + 'hunxoe.data'
    monomer_gjf = refdir + 'hunxoe.gjf'
    atomtypesets_from1 = [[1],[2,3],[4,7],[9],[5,8],[10,13],[14],[6],[12],[11],[16,17],\
                          [18],[21,22,23],[15],[19,20],[24,26],[28],[25,27],[29,30],[31],[32,33]]
    atomtypesets = [[v-1 for v in list0] for list0 in atomtypesets_from1]

    # crystal lat
    lat_gjf  = refdir + 'hunxoe_lat.gjf'

    Hsubl    = 124 # [KJ/mol]  McDonagh2016
    T = 298 # K
    ...
    pes_dirs = [refdir + 'pes0/',refdir + 'pes1/',refdir + 'pes2/',refdir + 'pes3/',\
                refdir + 'pes4/',refdir + 'pes5/']
    #pes_dirs = []

    # ff_load
    path_ff_load = ''
    #path_ff_load = root + '../ff_opt02.pickle'
    ...
    ff_ini, work = delff_lat.prepare(root,
                                     ...
                                     ewald=True,
                                     alpha_ewald= 0.22161174,
                                     nkmaxs=jnp.array([3,1,3])
                                     )
    if algo in ['BO']:
