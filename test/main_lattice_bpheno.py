...
def main(idx,algo):
    ...
    # monomer
    in_settings_file = refdir + 'bpheno.in.settings'
    data_file = refdir + 'bpheno.data'
    monomer_gjf = refdir + 'bpheno.gjf'
    atomtypesets_from1 = [[1,11],[2,15],[3,16],[4,17],[5,18],[6],[7,19],[8,20],[9,21],[10,22],[12],[13,23],[14,24]]
    atomtypesets = [[v-1 for v in list0] for list0 in atomtypesets_from1]

    # crystal lat
    lat_gjf  = refdir + 'bpheno_lat.gjf'

    Hsubl    = 89.1 # [KJ/mol]  McDonagh2016
    T = 298.00 # K
